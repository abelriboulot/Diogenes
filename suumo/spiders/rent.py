...
#    def parse_properties(self, response):
    ...
    def parse_details(self, response):
        ...
        itemrent.replace_xpath('title',u"//h1[contains(@class,\"section_title\")]/text()")
        itemrent.replace_xpath('Shiki',u"//span[text()=\"敷\"]/../span[last()]/text()")
        itemrent.replace_xpath('Rei',u"//span[text()=\"礼\"]/../span[last()]/text()")
        itemrent.replace_xpath('Typoroom',u"//td[contains(@class,\"detailinfo-col--03\")][1]//div[contains(@class,\"detailvalue-txt\")][1]/text()")
        itemrent.replace_xpath('m2',u"//td[contains(@class,\"detailinfo-col--03\")][1]//div[contains(@class,\"detailvalue-txt\")][2]/text()")
        itemrent.replace_xpath('unknown3',u"//td[contains(@class,\"detailinfo-col--03\")][1]//div[contains(@class,\"detailvalue-txt\")][3]/text()")
        itemrent.replace_xpath('manshionka',u"//td[contains(@class,\"detailinfo-col--03\")][2]//div[contains(@class,\"detailvalue-txt\")][1]/text()")
        ...
        itemrent.replace_xpath('insurance',u"//th[text()='損保']/../td[1]/text()")
        itemrent.replace_xpath('moving_in',u"//th[text()='入居']/../td[1]/text()")
